...
@Tag("IT")
@Slf4j
public class TestSerializationPlayerKeyLong {


  @Test
  @DisplayName("testCommonKeyLongCommonPlayer")
  public void testCommonKeyLongCommonPlayer() {
    log.info("testCommonKeyLongCommonPlayer");
    String where = EnvManager.getInstance().getValue(EnvManager.RUN_FOLDER_PARAM) + "/temp/playerA";
    try {
