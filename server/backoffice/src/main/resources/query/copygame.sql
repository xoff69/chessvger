INSERT INTO admin.common_game (black_elo, date, event_date, favori, interet,
...
FROM dblink(
             ...
             'SELECT black_elo, date, event_date, favori, interet,
              ...
              FROM admin.common_game'
                        ...
                        is_deleted BOOLEAN, last_position INTEGER, nb_coups INTEGER, partie_analysee BOOLEAN,
                        theorique BOOLEAN,
                        white_elo INTEGER, black_fide_id BIGINT, id BIGINT, informations_fait_de_jeu BIGINT,
                        last_update BIGINT,
                        white_fide_id BIGINT, moves VARCHAR(3000), black_player VARCHAR(255), black_title VARCHAR(255),
                        eco VARCHAR(255),
                        event VARCHAR(255), first_move VARCHAR(255), opening VARCHAR(255), result VARCHAR(255),
                        round VARCHAR(255),
